...
namespace UnityEditor.PostProcessing
{
    ...
    internal sealed class TrackballGroupDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            System.Collections.IEnumerator enumerator = property.GetEnumerator();
        ...
        private void OnWheelGUI(Rect position, int size, SerializedProperty property)
        {
            ...
            if (Event.current.type == EventType.Repaint)
            {
                ...
                RenderTexture rt = RenderTexture.GetTemporary((int)(size * scale), (int)(size * scale), 0, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Linear);
                ...
                thumbPos *= len;
                Vector2 thumbSize = FxStyles.wheelThumbSize;
        ...
        private bool TryGetDisplayValue(Color color, SerializedProperty property, out Vector3 output)
        {
            ...
            {
                FieldInfo field = ReflectionUtils.GetFieldInfoFromPath(property.serializedObject.targetObject, property.propertyPath);
                ...
                TrackballAttribute attr = (TrackballAttribute)field.GetCustomAttributes(typeof(TrackballAttribute), false)[0];
